...
seriesOfNumbers = seriesOfNumbers + ","; //дополнительная запятая для 
// обозначения конца строки 
string RemovingSpaces(string series) //Фуекция удаления пробелов
{
    string seriesNew = "";
...
int[] ArrayOfNumbers(string seriesNew)
{
    ...
    for (int i = 0; i < seriesNew.Length; i++)
    {
        ...
        arrayOfNumbers[j] = Convert.ToInt32(seriesNew1); // Заполняет массив значениями
        //из строки
